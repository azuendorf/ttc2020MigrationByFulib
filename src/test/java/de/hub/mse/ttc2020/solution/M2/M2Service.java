...
public class M2Service 
{
   ...
   public M2Service setSessionToAppMap(LinkedHashMap<String, M2App> value)
   {
      ...
      {
         LinkedHashMap<String, M2App> oldValue = this.sessionToAppMap;
   ...
   private M2Editor modelEditor = null;
   ...
   public M2Service setModelEditor(M2Editor value)
   {
      ...
      {
         M2Editor oldValue = this.modelEditor;
   ...
   public static final ArrayList<CommandStream> EMPTY_streams = new ArrayList<CommandStream>()
   ...
   private ArrayList<CommandStream> streams = null;
   ...
   public M2Service withStreams(Object... value)
   {
      ...
      for (Object item : value)
      {
         ...
         else if (item instanceof CommandStream)
         {
            if (this.streams == null)
            {
               this.streams = new ArrayList<CommandStream>();
            }
   ...
   public M2Service withoutStreams(Object... value)
   {
